...
urlpatterns = [
    ...
    path('<int:id>/confirm_delete', views.confirm_delete_matrix, name='confirm_delete_matrix'),
    ...
    path('<int:matrix_id>/flow/<int:flow_id>/confirm_delete', views.confirm_delete_flow, name='confirm_delete_flow'),
